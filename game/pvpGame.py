    ...
    def main(self, screen):
        ...
        while self.SB == 0:
            ...
            background1 = pygame.transform.scale(
                background1, (self.size[0]/2, self.size[1]))  # 왼쪽
            ...
            time_score_life_text1 = font.render("Time : {:} Score : {} Life: {} ".format(
                timer, self.score_player1, self.life_player1), True, Color.YELLOW.value)  # 폰트가지고 랜더링 하는데 표시할 내용, True는 글자가 잘 안깨지게 하는 거임 걍 켜두기, 글자의 색깔
            time_score_life_text2 = font.render("Time : {:} Score : {} Life: {} ".format(
                timer, self.score_player2, self.life_player2), True, Color.YELLOW.value)  # 폰트가지고 랜더링 하는데 표시할 내용, True는 글자가 잘 안깨지게 하는 거임 걍 켜두기, 글자의 색깔
            # 이미지화 한 텍스트라 이미지를 보여준다고 생각하면 됨
            self.screen.blit(time_score_life_text1, (10, 15))
            # 이미지화 한 텍스트라 이미지를 보여준다고 생각하면 됨
            self.screen.blit(time_score_life_text2, (10+self.size[0]/2, 15))
            ...
            if timer <= 0:
                ...
                if self.score_player1 > self.score_player2:
                    ...
                    # 폰트가지고 랜더링 하는데 표시할 내용, True는 글자가 잘 안깨지게 하는 거임 걍 켜두기, 글자의 색깔
                    score_player1 = font2.render("Player1 Score : {} ".format(
                        self.score_player1), True, Color.WHITE.value)
                    score_player2 = font2.render("Player2 Score : {} ".format(
                        self.score_player2), True, Color.WHITE.value)
                    self.screen.blit(
                        score_player1, (self.size[0]/3-15, self.size[1]/2+80))
                    self.screen.blit(
                        score_player2, (self.size[0]/3-15, self.size[1]/2+120))

                if self.score_player2 > self.score_player1:
                    pygame.mixer.music.stop()
                    self.win2 = pygame.image.load(self.gameover_image2)
                    self.win2 = pygame.transform.scale(
                        self.win2, (self.size[0], self.size[1]))
                    self.screen.fill(Color.BLACK.value)
                ...
                if self.score_player1 == self.score_player2:
                    ...
                    self.same = pygame.transform.scale(
                        self.same, (self.size[0], self.size[1]))
                    self.screen.fill(Color.BLACK.value)
