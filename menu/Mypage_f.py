...
class Mypage_f:
    ...
    def show(self, character):
        ...
        if choosed_character == "firefighter":
            ...
            curs.close()
            self.character_data = CharacterDataManager.load()
            front_image_path = [Images.firefighter1.value,Images.cat2.value, Images.cat3.value]
            ...
            for i in range(1,4):
                ...
                if(fchar > -1): 
                    ...
                    fcharacters.append((self.character_data[i-1].name, i-1)) #보유하고 있는 캐릭터 이름만 저장
    ...
    def update_from_selection(self, selected_value, **kwargs) -> None:
        ...
        elif User.firefighter_lock[selected_value] == False:
            self.status2 = "Unlocked"
        else:
            self.status2 = "Locked"

        self.current = selected_value
        self.image_widget.set_image(self.fcharacter_imgs2[selected_value])
