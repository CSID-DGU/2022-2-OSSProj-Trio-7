...
class CharacterBuy_f:
    def __init__(self,screen,character):
        ...
        if(character == 'fire1'):
            self.menu_image = pygame_menu.baseimage.BaseImage(image_path=Images.failbuy_fire1.value,drawing_mode=pygame_menu.baseimage.IMAGE_MODE_FILL)
        elif(character == 'fire2'):
             self.menu_image = pygame_menu.baseimage.BaseImage(image_path=Images.failbuy_fire2.value,drawing_mode=pygame_menu.baseimage.IMAGE_MODE_FILL)
