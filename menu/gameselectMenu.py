...
class GameselectMenu:
    def __init__(self, screen):
        ...
        self.gamemode = button(self.board_height, self.board_height,
                               0.366, 0.05, 0.1, 0.05, "Image/catthema/STAGE.png")
        self.store = button(self.board_height, self.board_height,
                            0.233, 0.05, 0.1, 0.05, "Image/catthema/STORE.png")
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEMOTION:  # 마우스모션
                    ...
                    if self.level_map1.isOver(pos):
                        ...
                        self.level_map1.image = self.temp1
                    pygame.display.update()
                    ...
                    if self.level_map2.isOver(pos):
                        ...
                        self.level_map2.image = self.temp2
                    pygame.display.update()
                    ...
                    if self.level_map3.isOver(pos):
                        ...
                        self.level_map3.image = self.temp3
                    pygame.display.update()
